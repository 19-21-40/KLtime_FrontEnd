            ...
            <Body_line>
                <Component_position>
                    <Left_component>
                        <Header_Chart_Box>
                            <Design_Box>
                                <Piechart canOpen={false} Full_num={data?.gradcondition.gradCredit} Already_num={data?.credit.totalCredit} Kind="총학점" section="total" Chart_size={280} Width={650} Height={320} Top_css={25} Left_css={0} font_1={30} font_2={20} margin_t={70} />
                            </Design_Box>
                        </Header_Chart_Box>
                        <Body_Chart_Box>
                            <Upper_Body_Chart_Box>
                                <Design_Box>
                                    <Piechart canOpen={true} Full_num={data?.gradcondition.mainCredit} Already_num={data?.credit.mainCredit} Kind="전공학점" section="main" Chart_size={150} Width={320} Height={207.2} Top_css={35} Left_css={5} font_1={30} font_2={20} margin_t={10} />
                                </Design_Box>
                                <Design_Box>
                                    <Piechart canOpen={data?.gradcondition.multiCredit==0 ? false : true } Full_num={data?.gradcondition.multiCredit} Already_num={data?.credit.multiCredit} Kind="부전공학점" section="sub" Chart_size={150} Width={320} Height={207.2} Top_css={35} Left_css={5} font_1={30} font_2={20} />
                                </Design_Box>
                            </Upper_Body_Chart_Box>
                            <Lower_Body_Chart_Box>
                                ...
                                <Design_Box>
                                    <Small_Body_Chart_Box>
                                        <Su_Body_Chart_Box>
                                            <Piechart canOpen={true} Full_num={data?.gradcondition.essBalCredit} Already_num={data?.credit.balCredit + data?.credit.essCredit} Kind="교양학점" section="essBal" Chart_size={150} Width={325} Height={160} Top_css={35} Left_css={5} font_1={30} font_2={20} margin_t={10} />
                                        </Su_Body_Chart_Box>
                                        <Sl_Body_Chart_Box>
                                            <Piechart canOpen={true} Full_num={0} Already_num={data?.credit.balCredit} Kind="균형" section="bal" Chart_size={100} Width={162.5} Height={80} Top_css={35} Left_css={15} font_1={25} font_2={15} margin_t={10} />
                                            <Piechart canOpen={true} Full_num={0} Already_num={data?.credit.essCredit} Kind="필수" section="ess" Chart_size={100} Width={162.5} Height={80} Top_css={35} Left_css={15} font_1={25} font_2={15} margin_t={10} />
                                        </Sl_Body_Chart_Box>
                                    </Small_Body_Chart_Box>
                                </Design_Box>
                            </Lower_Body_Chart_Box>

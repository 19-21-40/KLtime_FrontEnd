    ...
    return (
        <Total_Container>
                <Left_Container>
                    ...
                    {openSelect && <div>
                        <Time_Table_Menu nextNumber={nextNumber} setTableId={setTableId} setOpenSelect={setOpenSelect} setOpenDetail={setOpenDetail} innerText ={innerText} setInnerText={setInnerText}/>
                        </div>}
                    {openDetail && <div>
